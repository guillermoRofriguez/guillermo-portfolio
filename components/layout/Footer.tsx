...
export default function Footer() {
  return (
    <footer className="py-40 border-t border-[#3C4A46]/10">
      <Container>
        <div className="flex lg:flex-row flex-wrap items-center justify-center gap-x-4 max-lg:gap-y-7 lg:justify-between">
          ...
          <div className="flex items-start gap-x-6 ">
            <Link className="focus:outline-none text-[#BACAC5] text-lg" href="https://www.linkedin.com/in/guillermo-rodriguez-068432223/" target="_blank">LinkedIn</Link>
